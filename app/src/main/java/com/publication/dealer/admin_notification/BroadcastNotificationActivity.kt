...
import com.publication.dealer.databinding.ActivityBroadcastNotificationBinding
...
class BroadcastNotificationActivity : AppCompatActivity() {
    ...
    private val viewModel: BroadCastNotificationViewModel by viewModel()
